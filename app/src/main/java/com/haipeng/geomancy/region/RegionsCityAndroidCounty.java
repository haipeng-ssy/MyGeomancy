...
public class RegionsCityAndroidCounty {
    public String CityAndCounty[][] = {
//北京市
            {"北京市", "东城区", "西城区", "朝阳区", "丰台区", "石景山区", "海淀区", "门头沟区", "房山区", "通州区", "顺义区", "昌平区", "大兴区", "怀柔区", "平谷区", "密云县", "延庆县"},
//天津市
            {"天津市", "和平区", "河东区", "河西区", "南开区", "河北区", "红桥区", "滨海新区", "东丽区", "西青区", "津南区", "北辰区", "武清区", "宝坻区", "宁河县", "静海县", "蓟县"},
//河北省
            {"石家庄市", "长安区", "桥东区", "桥西区", "新华区", "井陉矿区", "裕华区", "辛集市", "藁城市", "晋州市", "新乐市", "鹿泉市", "井陉县", "正定县", "栾城县", "行唐县", "灵寿县", "高邑县", "深泽县", "赞皇县", "无极县", "平山县", "元氏县", "赵县"},
            {"唐山市", "路南区", "路北区", "古冶区", "开平区", "丰南区", "丰润区", "遵化市", "迁安市", "滦县", "滦南县", "乐亭县", "迁西县", "玉田县", "唐海县"},
            {"秦皇岛市", "海港区", "山海关区", "北戴河区", "青龙满族自治县", "昌黎县", "抚宁县", "卢龙县"},
            {"邯郸市", "邯山区", "丛台区", "复兴区", "峰峰矿区", "武安市", "邯郸县", "临漳县", "成安县", "大名县", "涉县", "磁县", "肥乡县", "永年县", "邱县", "鸡泽县", "广平县", "馆陶县", "魏县", "曲周县"},
            {"邢台市", "桥东区", "桥西区", "南宫市", "沙河市", "邢台县", "临城县", "内丘县", "柏乡县", "隆尧县", "任县", "南和县", "宁晋县", "巨鹿县", "新河县", "广宗县", "平乡县", "威县", "清河县", "临西县"},
            {"保定市", "新市区", "北市区", "南市区", "涿州市", "定州市", "安国市", "高碑店市", "满城县", "清苑县", "涞水县", "阜平县", "徐水县", "定兴县", "唐县", "高阳县", "容城县", "涞源县", "望都县", "安新县", "易县", "曲阳县", "蠡县", "顺平县", "博野县", "雄县"},
...
//山西省
            ...
            {"晋中市", "榆次区", "介休市", "榆社县", "左权县", "和顺县", "昔阳县", "寿阳县", "太谷县", "祁县", "平遥县", "灵石县"},
...
//内蒙古自治区
            {"呼和浩特市", "新城区", "回民区", "玉泉区", "赛罕区", "托克托县", "和林格尔县", "清水河县", "武川县", "土默特左旗"},
            {"包头市", "东河区", "昆都仑区", "青山区", "石拐区", "白云矿区", "九原区", "固阳县", "土默特右旗", "达尔罕茂明安联合旗"},
            {"乌海市", "海勃湾区", "海南区", "乌达区"},
            {"赤峰市", "红山区", "元宝山区", "松山区", "林西县", "宁城县", "阿鲁科尔沁旗", "巴林左旗", "巴林右旗", "克什克腾旗", "翁牛特旗", "喀喇沁旗", "敖汉旗"},
            {"通辽市", "科尔沁区", "科尔沁左翼中旗", "科尔沁左翼后旗", "开鲁县", "库伦旗", "奈曼旗", "扎鲁特旗", "霍林郭勒市"},
            {"鄂尔多斯市", "东胜区", "达拉特旗", "准格尔旗", "鄂托克前旗", "鄂托克旗", "杭锦旗", "乌审旗", "伊金霍洛旗"},
            {"呼伦贝尔市", "海拉尔区", "满洲里市", "牙克石市", "扎兰屯市", "额尔古纳市", "根河市", "阿荣旗", "莫力达瓦达斡尔族自治旗", "鄂伦春自治旗", "鄂温克族自治旗", "陈巴尔虎旗", "新巴尔虎左旗", "新巴尔虎右旗"},
            ...
            {"锡林郭勒盟", "二连浩特市", "锡林浩特市", "多伦县", "阿巴嘎旗", "苏尼特左旗", "苏尼特右旗", "东乌珠穆沁旗", "西乌珠穆沁旗", "太仆寺旗", "镶黄旗", "正镶白旗", "正蓝旗"},
            {"阿拉善盟", "阿拉善左旗", "阿拉善右旗", "额济纳旗"},
//辽宁省
            {"沈阳市", "和平区", "沈河区", "大东区", "皇姑区", "铁西区", "苏家屯区", "东陵区", "沈北新区", "于洪区", "新民市", "辽中县", "康平县", "法库县"},
            {"大连市", "中山区", "西岗区", "沙河口区", "甘井子区", "旅顺口区", "金州区", "瓦房店市", "普兰店市", "庄河市", "长海县"},
...
//吉林省
            {"长春市", "南关区", "宽城区", "朝阳区", "二道区", "绿园区", "双阳区", "九台市", "榆树市", "德惠市", "农安县"},
...
//黑龙江省
            {"哈尔滨市", "道里区", "南岗区", "道外区", "平房区", "松北区", "香坊区", "呼兰区", "阿城区", "双城市", "尚志市", "五常市", "依兰县", "方正县", "宾县", "巴彦县", "木兰县", "通河县", "延寿县"},
            ...
            {"佳木斯市", "向阳区", "前进区", "东风区", "郊区", "同江市", "富锦市", "桦南县", "桦川县", "汤原县", "抚远县"},
            {"七台河市", "新兴区", "桃山区", "茄子河区", "勃利县"},
            {"牡丹江市", "东安区", "阳明区", "爱民区", "西安区", "绥芬河市", "海林市", "宁安市", "穆棱市", "东宁县", "林口县"},
            {"黑河市", "爱辉区", "北安市", "五大连池市", "嫩江县", "逊克县", "孙吴县"},
            {"绥化市", "北林区", "安达市", "肇东市", "海伦市", "望奎县", "兰西县", "青冈县", "庆安县", "明水县", "绥棱县"},
            {"大兴安岭地区", "呼中区", "新林区", "松岭区", "加格达奇区", "呼玛县", "塔河县", "漠河县"},
//上海市
...
//江苏省
            ...
            {"无锡市", "崇安区", "南长区", "北塘区", "锡山区", "惠山区", "滨湖区", "新区", "江阴市", "宜兴市"},
            {"徐州市", "鼓楼区", "云龙区", "贾汪区", "泉山区", "铜山区", "新沂市", "邳州市", "丰县", "沛县", "睢宁县"},
            {"常州市", "天宁区", "钟楼区", "戚墅堰区", "新北区", "武进区", "溧阳市", "金坛市"},
            {"苏州市", "沧浪区", "平江区", "金阊区", "虎丘区", "吴中区", "相城区", "苏州工业园区", "常熟市", "张家港市", "昆山市", "吴江市", "太仓市"},
            {"南通市", "崇川区", "港闸区", "通州区", "启东市", "如皋市", "海门市", "海安县", "如东县"},
            {"连云港市", "连云区", "新浦区", "海州区", "赣榆县", "东海县", "灌云县", "灌南县"},
            {"淮安市", "清河区", "楚州区", "淮阴区", "清浦区", "涟水县", "洪泽县", "盱眙县", "金湖县"},
            {"盐城市", "亭湖区", "盐都区", "东台市", "大丰市", "响水县", "滨海县", "阜宁县", "射阳县", "建湖县"},
            {"扬州市", "广陵区", "邗江区", "维扬区", "仪征市", "高邮市", "江都市", "宝应县"},
            {"镇江市", "京口区", "润州区", "丹徒区", "丹阳市", "扬中市", "句容市"},
            {"泰州市", "海陵区", "高港区", "兴化市", "靖江市", "泰兴市", "姜堰市"},
            {"宿迁市", "宿城区", "宿豫区", "沭阳县", "泗阳县", "泗洪县"},
//浙江省
            {"杭州市", "上城区", "下城区", "江干区", "拱墅区", "西湖区", "滨江区", "萧山区", "余杭区", "建德市", "富阳市", "临安市", "桐庐县", "淳安县"},
...
//安徽省
            ...
            {"安庆市", "迎江区", "大观区", "宜秀区", "桐城市", "怀宁县", "枞阳县", "潜山县", "太湖县", "宿松县", "望江县", "岳西县"},
...
//福建省
            {"福州市", "鼓楼区", "台江区", "仓山区", "马尾区", "晋安区", "福清市", "长乐市", "闽侯县", "连江县", "罗源县", "闽清县", "永泰县", "平潭县"},
            ...
            {"南平市", "延平区", "邵武市", "武夷山市", "建瓯市", "建阳市", "顺昌县", "浦城县", "光泽县", "松溪县", "政和县"},
            {"龙岩市", "新罗区", "漳平市", "长汀县", "永定县", "上杭县", "武平县", "连城县"},
...
//江西省
            ...
            {"九江市", "庐山区", "浔阳区", "瑞昌市", "九江县", "武宁县", "修水县", "永修县", "德安县", "星子县", "都昌县", "湖口县", "彭泽县"},
            {"新余市", "渝水区", "分宜县"},
            {"鹰潭市", "月湖区", "贵溪市", "余江县"},
            {"赣州市", "章贡区", "瑞金市", "南康市", "赣县", "信丰县", "大余县", "上犹县", "崇义县", "安远县", "龙南县", "定南县", "全南县", "宁都县", "于都县", "兴国县", "会昌县", "寻乌县", "石城县"},
            ...
            {"上饶市", "信州区", "德兴市", "上饶县", "广丰县", "玉山县", "铅山县", "横峰县", "弋阳县", "余干县", "鄱阳县", "万年县", "婺源县"},
//山东省
...
//湖北省
            ...
            {"十堰市", "茅箭区", "张湾区", "丹江口市", "郧县", "郧西县", "竹山县", "竹溪县", "房县"},
            ...
            {"神农架林区", "神农架林区"},
//湖南省
            {"长沙市", "芙蓉区", "天心区", "岳麓区", "开福区", "雨花区", "望城区", "浏阳市", "长沙县", "宁乡县"},
            {"株洲市", "荷塘区", "芦淞区", "石峰区", "天元区", "醴陵市", "株洲县", "攸县", "茶陵县", "炎陵县"},
...
//广东省
            ...
            {"阳江市", "江城区", "阳春市", "阳西县", "阳东县"},
            {"清远市", "清城区", "英德市", "连州市", "佛冈县", "阳山县", "连山瑶族自治县", "连南瑶族自治县", "清新县"},
            {"东莞市", "东莞市"},
            {"中山市", "中山市"},
            {"潮州市", "湘桥区", "潮安县", "饶平县"},
...
//广西壮族自治区
            ...
            {"河池市", "金城江区", "宜州市", "南丹县", "天峨县", "凤山县", "东兰县", "罗城仫佬族自治县", "环江毛南族自治县", "巴马瑶族自治县", "都安瑶族自治县", "大化瑶族自治县"},
            {"来宾市", "兴宾区", "合山市", "忻城县", "象州县", "武宣县", "金秀瑶族自治县"},
            {"崇左市", "江洲区", "凭祥市", "扶绥县", "宁明县", "龙州县", "大新县", "天等县"},
//海南省
            {"海口市", "秀英区", "龙华区", "琼山区", "美兰区"},
            {"三亚市", "三亚市"},
            {"五指山市", "五指山市"},
...
//重庆市
            {"重庆市", "万州区", "涪陵区", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "渝北区", "巴南区", "黔江区", "长寿区", "江津区", "合川区", "永川区", "南川区", "綦江区", "潼南县", "铜梁县", "大足区", "荣昌县", "璧山县", "梁平县", "城口县", "丰都县", "垫江县", "武隆县", "忠县", "开县", "云阳县", "奉节县", "巫山县", "巫溪县", "石柱土家族自治县", "秀山土家族苗族自治县", "酉阳土家族苗族自治县", "彭水苗族土家族自治县"},
//四川省
            {"成都市", "锦江区", "青羊区", "金牛区", "武侯区", "成华区", "龙泉驿区", "青白江区", "新都区", "温江区", "都江堰市", "彭州市", "邛崃市", "崇州市", "金堂县", "双流县", "郫县", "大邑县", "蒲江县", "新津县"},
...
//贵州省
            {"贵阳市", "南明区", "云岩区", "花溪区", "乌当区", "白云区", "小河区", "清镇市", "开阳县", "息烽县", "修文县"},
            {"六盘水市", "钟山区", "六枝特区", "水城县", "盘县"},
            {"遵义市", "红花岗区", "汇川区", "赤水市", "仁怀市", "遵义县", "桐梓县", "绥阳县", "正安县", "道真仡佬族苗族自治县", "务川仡佬族苗族自治县", "凤冈县", "湄潭县", "余庆县", "习水县"},
...
//云南省
            {"昆明市", "五华区", "盘龙区", "官渡区", "西山区", "东川区", "呈贡区", "安宁市", "晋宁县", "富民县", "宜良县", "石林彝族自治县", "嵩明县", "禄劝彝族苗族自治县", "寻甸彝族自治县"},
            {"曲靖市", "麒麟区", "宣威市", "马龙县", "陆良县", "师宗县", "罗平县", "富源县", "会泽县", "沾益县"},
...
//陕西省
            ...
            {"咸阳市", "秦都区", "杨凌区", "渭城区", "兴平市", "三原县", "泾阳县", "乾县", "礼泉县", "永寿县", "彬县", "长武县", "旬邑县", "淳化县", "武功县"},
...
//新疆维吾尔自治区
            ...
            {"昌吉自治州", "昌吉市", "阜康市", "呼图壁县", "玛纳斯县", "奇台县", "吉木萨尔县", "木垒哈萨克自治县"},
            {"博尔塔拉蒙古自治州", "博乐市", "精河县", "温泉县"},
            {"巴音郭楞蒙古自治州", "库尔勒市", "轮台县", "尉犁县", "若羌县", "且末县", "焉耆自治县", "和静县", "和硕县", "博湖县"},
